...
def process_xml(subcommand: str, openai_key: str, input_path: str, output_path: str, model: str, lang: str) -> None:
    """
    ...
    response = openai_prompt_with_xml(xml_data, openai_key, subcommand, model, lang)
