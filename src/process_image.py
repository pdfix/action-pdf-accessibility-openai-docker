...
def process_image(
    openai_key: str, input_path: str, output_path: str, model: str, lang: str, mathml_version: str, prompt: str
) -> None:
    """
    ...
    response = openai_prompt_with_image(base64_image, openai_key, model, lang, mathml_version, prompt)
